...
#define __ptrauth_objc_class_ro __ptrauth(ptrauth_key_objc_class_ro_pointer, 1, __ptrauth_objc_class_ro_discriminator)
...
/* definition of ptrauth_auth_load_relative_and_sign  not provided. We should obsolete this entirely.*/
