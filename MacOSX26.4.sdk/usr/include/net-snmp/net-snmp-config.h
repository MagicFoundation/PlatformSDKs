...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--disable-dependency-tracking' '--sysconfdir=/etc' '--with-install-prefix=/AppleInternal/Library/BuildRoots/4~CJjrugDyvvAYHBhtueFVOLzo1RNhTsHospiVz7E/Library/Caches/com.apple.xbs/TemporaryDirectory.RxumFP/Binaries/net_snmp/install/TempContent/Root' '--with-default-snmp-version=2' '--with-persistent-directory=/var/db/net-snmp' '--with-defaults' '--without-rpm' '--with-sys-contact=postmaster@example.com' '--with-mib-modules=host ucd-snmp/diskio ucd-snmp/loadave ' '--disable-static' '--enable-ipv6' '--without-perl-modules' '--disable-perl-cc-checks' '--disable-embedded-perl' '--datarootdir=/usr/share' '--with-openssl=/usr/libressl/' '--without-kmem-usage' 'CC=/AppleInternal/Library/BuildRoots/4~CJjrugDyvvAYHBhtueFVOLzo1RNhTsHospiVz7E/Applications/Xcode.app/Contents/Developer/Toolchains/OSX26.4.xctoolchain/usr/bin/cc' 'CFLAGS=-arch arm64e -arch x86_64 -g -Os -pipe -DBUILD=177 -DMACOSX_DEPLOYMENT_TARGET=26.4 -F/AppleInternal/Library/BuildRoots/4~CJjrugDyvvAYHBhtueFVOLzo1RNhTsHospiVz7E/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.4.Internal.sdk/System/Library/PrivateFrameworks/ -F/AppleInternal/Library/BuildRoots/4~CJjrugDyvvAYHBhtueFVOLzo1RNhTsHospiVz7E/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.4.Internal.sdk/System/Library/Frameworks/ -iwithsysroot /usr/local/libressl/include -L/AppleInternal/Library/BuildRoots/4~CJjrugDyvvAYHBhtueFVOLzo1RNhTsHospiVz7E/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.4.Internal.sdk/usr/local/libressl/lib' 'LDFLAGS=-arch arm64e -arch x86_64            '"
