...
#ifdef __LP64__
void __writex18byte(unsigned __int32 offset, unsigned char data);
void __writex18word(unsigned __int32 offset, unsigned short data);
void __writex18dword(unsigned __int32 offset, unsigned __int32 data);
void __writex18qword(unsigned __int32 offset, unsigned __int64 data);

unsigned char __readx18byte(unsigned __int32 offset);
unsigned short __readx18word(unsigned __int32 offset);
unsigned __int32 __readx18dword(unsigned __int32 offset);
unsigned __int64 __readx18qword(unsigned __int32 offset);
#else
