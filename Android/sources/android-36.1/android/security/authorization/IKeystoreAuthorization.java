...
public interface IKeystoreAuthorization extends android.os.IInterface
{
  ...
  public static class Default implements android.security.authorization.IKeystoreAuthorization
  {
     ...
     */
    @Override public void onUserStorageLocked(int userId) throws android.os.RemoteException
    {
    }
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements android.security.authorization.IKeystoreAuthorization
  {
    ...
    public static java.lang.String getDefaultTransactionName(int transactionCode)
    {
      switch (transactionCode)
      {
        ...
        case TRANSACTION_onUserStorageLocked:
        {
          return "onUserStorageLocked";
        }
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_onUserStorageLocked:
        {
          ...
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          this.onUserStorageLocked(_arg0);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_onWeakUnlockMethodsExpired:
    ...
    private static class Proxy implements android.security.authorization.IKeystoreAuthorization
    {
      ...
      @Override public void onUserStorageLocked(int userId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_onUserStorageLocked, _data, _reply, android.os.IBinder.FLAG_CLEAR_BUF);
          _reply.readException();
        }
        finally {
          _reply.recycle();
    ...
    static final int TRANSACTION_onUserStorageLocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
    static final int TRANSACTION_onWeakUnlockMethodsExpired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
    static final int TRANSACTION_onNonLskfUnlockMethodsExpired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    static final int TRANSACTION_getAuthTokensForCredStore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_getLastAuthTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    /** @hide */
   ...
   * @param userId - Android user id
   */
  public void onUserStorageLocked(int userId) throws android.os.RemoteException;
  /**
   * Tells Keystore that weak unlock methods can no longer unlock the device for the given user.
   * This is intended to be called after an earlier call to onDeviceLocked() with
   * weakUnlockEnabled=true.  It upgrades the security level of UnlockedDeviceRequired keys to
