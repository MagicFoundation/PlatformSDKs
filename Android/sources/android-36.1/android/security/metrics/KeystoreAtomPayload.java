...
public final class KeystoreAtomPayload implements android.os.Parcelable {
  ...
  public final static int keysPerUid = 9;  // android.security.metrics.KeysPerUid keysPerUid;
  ...
  // android.security.metrics.KeysPerUid keysPerUid;

  public static KeystoreAtomPayload keysPerUid(android.security.metrics.KeysPerUid _value) {
    return new KeystoreAtomPayload(keysPerUid, _value);
  }

  public android.security.metrics.KeysPerUid getKeysPerUid() {
    _assertTag(keysPerUid);
    return (android.security.metrics.KeysPerUid) _value;
  }

  public void setKeysPerUid(android.security.metrics.KeysPerUid _value) {
    _set(keysPerUid, _value);
  }
  ...
  public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
    ...
    case crashStats:
      ...
      break;
    case keysPerUid:
      _aidl_parcel.writeTypedObject(getKeysPerUid(), _aidl_flag);
      break;
    }
  }
  ...
  public void readFromParcel(android.os.Parcel _aidl_parcel) {
    ...
    case crashStats: {
      ...
      return; }
    case keysPerUid: {
      android.security.metrics.KeysPerUid _aidl_value;
      _aidl_value = _aidl_parcel.readTypedObject(android.security.metrics.KeysPerUid.CREATOR);
      _set(_aidl_tag, _aidl_value);
      return; }
    }
  ...
  public int describeContents() {
    ...
    case crashStats:
      ...
      break;
    case keysPerUid:
      _mask |= describeContents(getKeysPerUid());
      break;
    }
    return _mask;
  }
  ...
  private String _tagString(int _tag) {
    ...
    case keysPerUid: return "keysPerUid";
    }
  ...
  public static @interface Tag {
    ...
    public static final int keysPerUid = 9;
  }
}
