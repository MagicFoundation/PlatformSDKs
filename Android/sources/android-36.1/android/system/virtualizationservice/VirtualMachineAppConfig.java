...
public class VirtualMachineAppConfig implements android.os.Parcelable
{
  ...
  public java.util.List<android.os.ParcelFileDescriptor> tenantIdsigs;
  ...
  public java.lang.String[] hostServices;
  /**
   ...
   * setup.
   */
  public boolean shouldDelayEncryptedStoreSetup = false;
  /** KEK used to set up the encrypted store or {@code null} if encrypted store uses default mode. */
  public android.system.virtualizationcommon.IEncryptedStoreKEK encryptedStoreKEK;
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeTypedList(tenantIdsigs, _aidl_flag);
    ...
    _aidl_parcel.writeStringArray(hostServices);
    _aidl_parcel.writeBoolean(shouldDelayEncryptedStoreSetup);
    _aidl_parcel.writeStrongInterface(encryptedStoreKEK);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      tenantIdsigs = _aidl_parcel.createTypedArrayList(android.os.ParcelFileDescriptor.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      hostServices = _aidl_parcel.createStringArray();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      shouldDelayEncryptedStoreSetup = _aidl_parcel.readBoolean();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      encryptedStoreKEK = android.system.virtualizationcommon.IEncryptedStoreKEK.Stub.asInterface(_aidl_parcel.readStrongBinder());
    } finally {
  ...
  public int describeContents() {
    ...
    _mask |= describeContents(tenantIdsigs);
