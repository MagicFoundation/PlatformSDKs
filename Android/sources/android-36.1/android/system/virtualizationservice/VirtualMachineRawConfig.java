...
public class VirtualMachineRawConfig implements android.os.Parcelable
{
  ...
  public android.os.ParcelFileDescriptor customPvmfw;
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeTypedObject(customPvmfw, _aidl_flag);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      customPvmfw = _aidl_parcel.readTypedObject(android.os.ParcelFileDescriptor.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public int describeContents() {
    ...
    _mask |= describeContents(customPvmfw);
