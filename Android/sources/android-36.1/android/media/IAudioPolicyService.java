...
public interface IAudioPolicyService extends android.os.IInterface
{
  ...
  public static class Default implements android.media.IAudioPolicyService
  {
    ...
    @Override public android.media.StartOutputResponse startOutput(int portId) throws android.os.RemoteException
    {
      return null;
    }
    ...
    @Override public void forceReleaseDirectOutput(int output) throws android.os.RemoteException
    {
    }
    ...
    @Override public void setVolumeIndexForGroup(int groupId, android.media.audio.common.AudioDeviceDescription device, int index, boolean muted) throws android.os.RemoteException
    {
    }
    @Override public int getVolumeIndexForGroup(int groupId, android.media.audio.common.AudioDeviceDescription device) throws android.os.RemoteException
    {
      return 0;
    }
    @Override public int getMaxVolumeIndexForGroup(int groupId) throws android.os.RemoteException
    {
      return 0;
    }
    @Override public int getMinVolumeIndexForGroup(int groupId) throws android.os.RemoteException
    {
      return 0;
    }
    @Override public void setMaxVolumeIndexForGroup(int groupId, int maxIndex) throws android.os.RemoteException
    {
    }
    @Override public void setMinVolumeIndexForGroup(int groupId, int minIndex) throws android.os.RemoteException
    {
    }
    /** product_strategy_t */
    ...
    @Override public android.media.audio.common.AudioAttributes getAttributesForStreamType(int stream) throws android.os.RemoteException
    {
      return null;
    }
    @Override public int getStreamTypeForAttributes(android.media.audio.common.AudioAttributes attributes) throws android.os.RemoteException
    {
      return 0;
    }
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.IAudioPolicyService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_startOutput:
        {
          ...
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.media.StartOutputResponse _result = this.startOutput(_arg0);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        ...
        case TRANSACTION_forceReleaseDirectOutput:
        {
          ...
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          this.forceReleaseDirectOutput(_arg0);
          reply.writeNoException();
          break;
        }
        ...
        case TRANSACTION_setVolumeIndexForGroup:
        {
          ...
          _arg3 = data.readBoolean();
          data.enforceNoDataAvail();
          this.setVolumeIndexForGroup(_arg0, _arg1, _arg2, _arg3);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_getVolumeIndexForGroup:
        {
          ...
          _arg1 = data.readTypedObject(android.media.audio.common.AudioDeviceDescription.CREATOR);
          data.enforceNoDataAvail();
          int _result = this.getVolumeIndexForGroup(_arg0, _arg1);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
        case TRANSACTION_getMaxVolumeIndexForGroup:
        {
          ...
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          int _result = this.getMaxVolumeIndexForGroup(_arg0);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
        case TRANSACTION_getMinVolumeIndexForGroup:
        {
          ...
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          int _result = this.getMinVolumeIndexForGroup(_arg0);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
        case TRANSACTION_setMaxVolumeIndexForGroup:
        {
          ...
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          this.setMaxVolumeIndexForGroup(_arg0, _arg1);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_setMinVolumeIndexForGroup:
        {
          ...
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          this.setMinVolumeIndexForGroup(_arg0, _arg1);
          reply.writeNoException();
          break;
        }
        ...
        case TRANSACTION_getAttributesForStreamType:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.media.audio.common.AudioAttributes _result = this.getAttributesForStreamType(_arg0);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        case TRANSACTION_getStreamTypeForAttributes:
        {
          android.media.audio.common.AudioAttributes _arg0;
          _arg0 = data.readTypedObject(android.media.audio.common.AudioAttributes.CREATOR);
          data.enforceNoDataAvail();
          int _result = this.getStreamTypeForAttributes(_arg0);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
    ...
    private static class Proxy implements android.media.IAudioPolicyService
    {
      ...
      @Override public android.media.StartOutputResponse startOutput(int portId) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.media.StartOutputResponse _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(portId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_startOutput, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.media.StartOutputResponse.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public void forceReleaseDirectOutput(int output) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_forceReleaseDirectOutput, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void setVolumeIndexForGroup(int groupId, android.media.audio.common.AudioDeviceDescription device, int index, boolean muted) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(index);
          _data.writeBoolean(muted);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setVolumeIndexForGroup, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public int getVolumeIndexForGroup(int groupId, android.media.audio.common.AudioDeviceDescription device) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(groupId);
          _data.writeTypedObject(device, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getVolumeIndexForGroup, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
      ...
      @Override public int getMaxVolumeIndexForGroup(int groupId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(groupId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getMaxVolumeIndexForGroup, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
      ...
      @Override public int getMinVolumeIndexForGroup(int groupId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(groupId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getMinVolumeIndexForGroup, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
      ...
      @Override public void setMaxVolumeIndexForGroup(int groupId, int maxIndex) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setMaxVolumeIndexForGroup, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void setMinVolumeIndexForGroup(int groupId, int minIndex) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(groupId);
          _data.writeInt(minIndex);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setMinVolumeIndexForGroup, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public android.media.audio.common.AudioAttributes getAttributesForStreamType(int stream) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.media.audio.common.AudioAttributes _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(stream);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getAttributesForStreamType, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.media.audio.common.AudioAttributes.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public int getStreamTypeForAttributes(android.media.audio.common.AudioAttributes attributes) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeTypedObject(attributes, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getStreamTypeForAttributes, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
    ...
    static final int TRANSACTION_forceReleaseDirectOutput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
    static final int TRANSACTION_getInputForAttr = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
    static final int TRANSACTION_startInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
    static final int TRANSACTION_stopInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_releaseInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
    static final int TRANSACTION_setDeviceAbsoluteVolumeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
    static final int TRANSACTION_initStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
    static final int TRANSACTION_setStreamVolumeIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
    static final int TRANSACTION_getStreamVolumeIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
    static final int TRANSACTION_setVolumeIndexForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
    static final int TRANSACTION_getVolumeIndexForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
    static final int TRANSACTION_getMaxVolumeIndexForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
    static final int TRANSACTION_getMinVolumeIndexForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
    static final int TRANSACTION_setVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
    static final int TRANSACTION_getVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
    static final int TRANSACTION_getMaxVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
    static final int TRANSACTION_getMinVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_setMaxVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
    static final int TRANSACTION_setMinVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    static final int TRANSACTION_getStrategyForStream = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
    static final int TRANSACTION_getDevicesForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
    static final int TRANSACTION_getOutputForEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
    static final int TRANSACTION_registerEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
    static final int TRANSACTION_unregisterEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
    static final int TRANSACTION_setEffectEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
    static final int TRANSACTION_moveEffectsToIo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
    static final int TRANSACTION_isStreamActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
    static final int TRANSACTION_isStreamActiveRemotely = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
    static final int TRANSACTION_isSourceActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
    static final int TRANSACTION_queryDefaultPreProcessing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
    static final int TRANSACTION_addSourceDefaultEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
    static final int TRANSACTION_addStreamDefaultEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
    static final int TRANSACTION_removeSourceDefaultEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
    static final int TRANSACTION_removeStreamDefaultEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
    static final int TRANSACTION_setSupportedSystemUsages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
    static final int TRANSACTION_setAllowedCapturePolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
    static final int TRANSACTION_getOffloadSupport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
    static final int TRANSACTION_isDirectOutputSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
    static final int TRANSACTION_listAudioPorts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
    static final int TRANSACTION_listDeclaredDevicePorts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
    static final int TRANSACTION_getAudioPort = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
    static final int TRANSACTION_createAudioPatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
    static final int TRANSACTION_releaseAudioPatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
    static final int TRANSACTION_listAudioPatches = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
    static final int TRANSACTION_setAudioPortConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
    static final int TRANSACTION_registerClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
    static final int TRANSACTION_setAudioPortCallbacksEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
    static final int TRANSACTION_setAudioVolumeGroupCallbacksEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
    static final int TRANSACTION_acquireSoundTriggerSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
    static final int TRANSACTION_releaseSoundTriggerSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
    static final int TRANSACTION_getPhoneState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
    static final int TRANSACTION_registerPolicyMixes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
    static final int TRANSACTION_getRegisteredPolicyMixes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
    static final int TRANSACTION_updatePolicyMixes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
    static final int TRANSACTION_setUidDeviceAffinities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
    static final int TRANSACTION_removeUidDeviceAffinities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
    static final int TRANSACTION_setUserIdDeviceAffinities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
    static final int TRANSACTION_removeUserIdDeviceAffinities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
    static final int TRANSACTION_startAudioSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
    static final int TRANSACTION_stopAudioSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
    static final int TRANSACTION_setMasterMono = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
    static final int TRANSACTION_getMasterMono = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
    static final int TRANSACTION_getStreamVolumeDB = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
    static final int TRANSACTION_getSurroundFormats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
    static final int TRANSACTION_getReportedSurroundFormats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
    static final int TRANSACTION_getHwOffloadFormatsSupportedForBluetoothMedia = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
    static final int TRANSACTION_setSurroundFormatEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
    static final int TRANSACTION_setAssistantServicesUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
    static final int TRANSACTION_setActiveAssistantServicesUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
    static final int TRANSACTION_setA11yServicesUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
    static final int TRANSACTION_setCurrentImeUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
    static final int TRANSACTION_isHapticPlaybackSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
    static final int TRANSACTION_isUltrasoundSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
    static final int TRANSACTION_isHotwordStreamSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
    static final int TRANSACTION_getAttributesForStreamType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
    static final int TRANSACTION_getStreamTypeForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
    static final int TRANSACTION_listAudioProductStrategies = (android.os.IBinder.FIRST_CALL_TRANSACTION + 88);
    static final int TRANSACTION_getProductStrategyFromAudioAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
    static final int TRANSACTION_listAudioVolumeGroups = (android.os.IBinder.FIRST_CALL_TRANSACTION + 90);
    static final int TRANSACTION_getVolumeGroupFromAudioAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 91);
    static final int TRANSACTION_setRttEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 92);
    static final int TRANSACTION_isCallScreenModeSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 93);
    static final int TRANSACTION_setDevicesRoleForStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 94);
    static final int TRANSACTION_removeDevicesRoleForStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 95);
    static final int TRANSACTION_clearDevicesRoleForStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 96);
    static final int TRANSACTION_getDevicesForRoleAndStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 97);
    static final int TRANSACTION_setDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 98);
    static final int TRANSACTION_addDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 99);
    static final int TRANSACTION_removeDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 100);
    static final int TRANSACTION_clearDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
    static final int TRANSACTION_getDevicesForRoleAndCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
    static final int TRANSACTION_registerSoundTriggerCaptureStateListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
    static final int TRANSACTION_getSpatializer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
    static final int TRANSACTION_canBeSpatialized = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
    static final int TRANSACTION_getDirectPlaybackSupport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
    static final int TRANSACTION_getDirectProfilesForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 107);
    static final int TRANSACTION_getSupportedMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 108);
    static final int TRANSACTION_setPreferredMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 109);
    static final int TRANSACTION_getPreferredMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 110);
    static final int TRANSACTION_clearPreferredMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 111);
    static final int TRANSACTION_getPermissionController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 112);
    static final int TRANSACTION_getMmapPolicyInfos = (android.os.IBinder.FIRST_CALL_TRANSACTION + 113);
    static final int TRANSACTION_getMmapPolicyForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 114);
    static final int TRANSACTION_setEnableHardening = (android.os.IBinder.FIRST_CALL_TRANSACTION + 115);
  }
  /** @hide */
  ...
  public android.media.StartOutputResponse startOutput(int portId) throws android.os.RemoteException;
  ...
  public void forceReleaseDirectOutput(int output) throws android.os.RemoteException;
  ...
  public void setVolumeIndexForGroup(int groupId, android.media.audio.common.AudioDeviceDescription device, int index, boolean muted) throws android.os.RemoteException;
  public int getVolumeIndexForGroup(int groupId, android.media.audio.common.AudioDeviceDescription device) throws android.os.RemoteException;
  public int getMaxVolumeIndexForGroup(int groupId) throws android.os.RemoteException;
  public int getMinVolumeIndexForGroup(int groupId) throws android.os.RemoteException;
  public void setMaxVolumeIndexForGroup(int groupId, int maxIndex) throws android.os.RemoteException;
  public void setMinVolumeIndexForGroup(int groupId, int minIndex) throws android.os.RemoteException;
  /** product_strategy_t */
  ...
  public android.media.audio.common.AudioAttributes getAttributesForStreamType(int stream) throws android.os.RemoteException;
  public int getStreamTypeForAttributes(android.media.audio.common.AudioAttributes attributes) throws android.os.RemoteException;
