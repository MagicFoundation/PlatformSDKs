...
public class HealthFitnessStatsLog {
     ...
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_DATA_BACKUP_INVOKED, int status, int time_to_succeed_or_fail_millis, int data_size_kb, int backup_type, int total_record_count);<br>
     */
    public static final int HEALTH_CONNECT_DATA_BACKUP_INVOKED = 1023;

    /**
     * HealthConnectMetadataBackupInvoked health_connect_metadata_backup_invoked<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_METADATA_BACKUP_INVOKED, int status, int time_to_succeed_or_fail_millis, int metadata_size_kb);<br>
     */
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED = 1024;

    /**
     * HealthConnectDataRestoreInvoked health_connect_data_restore_invoked<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_DATA_RESTORE_INVOKED, int status, int time_to_succeed_or_fail_millis, int data_size_kb, int total_record_count, int successful_record_count);<br>
     */
    public static final int HEALTH_CONNECT_DATA_RESTORE_INVOKED = 1025;

    /**
     * HealthConnectMetadataRestoreInvoked health_connect_metadata_restore_invoked<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_METADATA_RESTORE_INVOKED, int status, int time_to_succeed_or_fail_millis, int metadata_size_kb);<br>
     */
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED = 1026;
    ...
    /**
     * HealthConnectNotification health_connect_notification<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_NOTIFICATION, int notification_id, int notification_action);<br>
     */
    public static final int HEALTH_CONNECT_NOTIFICATION = 1105;

    /**
     * HealthConnectLatencyStats health_connect_latency_stats<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_LATENCY_STATS, java.lang.String package_name, int session_data_type, long latency);<br>
     */
    public static final int HEALTH_CONNECT_LATENCY_STATS = 1140;

    /**
     * HealthConnectRecordingMethodStats health_connect_recording_method_stats<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_RECORDING_METHOD_STATS, java.lang.String package_name, int data_type, int recording_method);<br>
     */
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS = 1157;

    /**
     * HealthConnectDeviceInfoStats health_connect_device_info_stats<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_DEVICE_INFO_STATS, java.lang.String package_name, int data_type, boolean has_manufacturer, boolean has_model, boolean has_type);<br>
     */
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS = 1160;

    /**
     * HealthConnectDataGranularityStats health_connect_data_granularity_stats<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_DATA_GRANULARITY_STATS, java.lang.String package_name, int granularity_data_type, long granularity, int data_state);<br>
     */
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS = 1165;

    /**
     * HealthConnectNativeTrackingStatsReported health_connect_native_tracking_stats_reported<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED, int[] native_data_types_active, int[] native_data_types_disabled, int number_of_writes, int uptime_seconds, int last_error_code, int steps_readers_count, int steps_writers_count);<br>
     */
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED = 1167;
    ...
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__CAN_CONNECT_MATCHING_APPS = 19;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__CREATE_CONNECT_MATCHING_APPS_INTENT = 20;
    ...
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__CONNECT_TWO_APPS_ONBOARDING_PAGE = 56;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__CONNECT_ONE_APP_ONBOARDING_PAGE = 57;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__ALMOST_DONE_PAGE = 58;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__FITNESS_APP_ONBOARDING_PAGE = 59;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__PRETTY_FHIR_PAGE = 60;
    ...
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ZERO_APPS_CONNECTED_BANNER = 298;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_DISMISS_BUTTON = 299;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_SET_UP_BUTTON = 300;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONE_APP_CONNECTED_BANNER = 301;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONE_APP_CONNECTED_BANNER_DISMISS_BUTTON = 302;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONE_APP_CONNECTED_BANNER_SET_UP_BUTTON = 303;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__APP_WITH_ONBOARDING_BUTTON = 304;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__APP_WITHOUT_ONBOARDING_BUTTON = 305;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__CONNECT_FIRST_TWO_APPS_ONBOARDING_SET_UP_LATER_BUTTON = 306;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__CONNECT_SECOND_APP_ONBOARDING_SET_UP_LATER_BUTTON = 307;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONBOARDING_APP_BUTTON = 308;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONBOARDING_DONE_BUTTON = 309;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_BACK_BUTTON = 310;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_DONE_BUTTON = 311;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_ALLOW_ALL_BUTTON = 312;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_PERMISSION_BUTTON = 313;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_LEARN_MORE_LINK = 314;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_PRIVACY_POLICY_LINK = 315;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MORE_ABOUT_HEALTH_CONNECT_BUTTON = 316;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONBOARDING_CONNECTED_APP_BUTTON = 317;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__PRETTY_FHIR_VIEW_SOURCE_DATA_BUTTON = 318;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__PRETTY_FHIR_HEADER_CONTAINER = 319;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__PRETTY_FHIR_GROUP_CONTAINER = 320;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_STEPS_BANNER = 321;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_STEPS_BANNER_DISMISS_BUTTON = 322;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_STEPS_BANNER_REVIEW_BUTTON = 323;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EMPTY_STATE_SHOW_SYSTEM_MENU = 324;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EMPTY_STATE_HIDE_SYSTEM_MENU = 325;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EXISTING_APPS_STATE_SHOW_SYSTEM_MENU = 326;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EXISTING_APPS_STATE_HIDE_SYSTEM_MENU = 327;
    ...
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__CONNECT_TWO_APPS_ONBOARDING_PAGE = 56;
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__CONNECT_ONE_APP_ONBOARDING_PAGE = 57;
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__ALMOST_DONE_PAGE = 58;
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__FITNESS_APP_ONBOARDING_PAGE = 59;
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__PRETTY_FHIR_PAGE = 60;
    ...
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ZERO_APPS_CONNECTED_BANNER = 298;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_DISMISS_BUTTON = 299;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_SET_UP_BUTTON = 300;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONE_APP_CONNECTED_BANNER = 301;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONE_APP_CONNECTED_BANNER_DISMISS_BUTTON = 302;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONE_APP_CONNECTED_BANNER_SET_UP_BUTTON = 303;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__APP_WITH_ONBOARDING_BUTTON = 304;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__APP_WITHOUT_ONBOARDING_BUTTON = 305;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__CONNECT_FIRST_TWO_APPS_ONBOARDING_SET_UP_LATER_BUTTON = 306;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__CONNECT_SECOND_APP_ONBOARDING_SET_UP_LATER_BUTTON = 307;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONBOARDING_APP_BUTTON = 308;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONBOARDING_DONE_BUTTON = 309;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_BACK_BUTTON = 310;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_DONE_BUTTON = 311;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_ALLOW_ALL_BUTTON = 312;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_PERMISSION_BUTTON = 313;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_LEARN_MORE_LINK = 314;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_PRIVACY_POLICY_LINK = 315;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MORE_ABOUT_HEALTH_CONNECT_BUTTON = 316;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONBOARDING_CONNECTED_APP_BUTTON = 317;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__PRETTY_FHIR_VIEW_SOURCE_DATA_BUTTON = 318;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__PRETTY_FHIR_HEADER_CONTAINER = 319;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__PRETTY_FHIR_GROUP_CONTAINER = 320;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_STEPS_BANNER = 321;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_STEPS_BANNER_DISMISS_BUTTON = 322;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_STEPS_BANNER_REVIEW_BUTTON = 323;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EMPTY_STATE_SHOW_SYSTEM_MENU = 324;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EMPTY_STATE_HIDE_SYSTEM_MENU = 325;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EXISTING_APPS_STATE_SHOW_SYSTEM_MENU = 326;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EXISTING_APPS_STATE_HIDE_SYSTEM_MENU = 327;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__CAN_CONNECT_MATCHING_APPS = 19;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__CREATE_CONNECT_MATCHING_APPS_INTENT = 20;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_ONE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_ONE__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_TWO__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_TWO__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_THREE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_THREE__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_FOUR__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_FOUR__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_FIVE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_FIVE__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_SIX__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_SIX__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__CAN_CONNECT_MATCHING_APPS = 19;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__CREATE_CONNECT_MATCHING_APPS_INTENT = 20;
    ...
    public static final int HEALTH_CONNECT_RESTRICTED_ECOSYSTEM_STATS__DATA_TYPE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_RESTRICTED_ECOSYSTEM_STATS__DATA_TYPE__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__READ_OR_WRITE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__READ_OR_WRITE__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__READ__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__READ__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__WRITE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__WRITE__SYMPTOMS = 46;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__SHARED__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__SHARED__SYMPTOMS = 46;
    ...
    // Values for HealthConnectMetadataBackupInvoked.status
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED__STATUS__METADATA_BACKUP_STATUS_ERROR_UNSPECIFIED = 0;
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED__STATUS__METADATA_BACKUP_STATUS_ERROR_NONE = 1;
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED__STATUS__METADATA_BACKUP_STATUS_ERROR_UNKNOWN = 2;
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED__STATUS__METADATA_BACKUP_STATUS_ERROR_COLLATION_FAILED = 3;
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED__STATUS__METADATA_BACKUP_STATUS_ERROR_PARTIAL_BACKUP = 4;
    public static final int HEALTH_CONNECT_METADATA_BACKUP_INVOKED__STATUS__METADATA_BACKUP_STATUS_STARTED = 5;
    ...
    // Values for HealthConnectMetadataRestoreInvoked.status
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED__STATUS__METADATA_RESTORE_STATUS_ERROR_UNSPECIFIED = 0;
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED__STATUS__METADATA_RESTORE_STATUS_ERROR_NONE = 1;
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED__STATUS__METADATA_RESTORE_STATUS_ERROR_UNKNOWN = 2;
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED__STATUS__METADATA_RESTORE_STATUS_ERROR_CONVERSION_FAILED = 3;
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED__STATUS__METADATA_RESTORE_STATUS_ERROR_PARTIAL_RESTORE = 4;
    public static final int HEALTH_CONNECT_METADATA_RESTORE_INVOKED__STATUS__METADATA_RESTORE_STATUS_STARTED = 5;

    // Values for HealthConnectNotification.notification_id
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ID__NOTIFICATION_ID_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ID__NOTIFICATION_ID_ZERO_APPS_CONNECTED = 1;
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ID__NOTIFICATION_ID_ONE_APP_CONNECTED = 2;

    // Values for HealthConnectNotification.notification_action
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ACTION__NOTIFICATION_ACTION_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ACTION__NOTIFICATION_ACTION_SENT = 1;
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ACTION__NOTIFICATION_ACTION_DISMISSED = 2;
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ACTION__NOTIFICATION_ACTION_CLICKED = 3;
    public static final int HEALTH_CONNECT_NOTIFICATION__NOTIFICATION_ACTION__NOTIFICATION_ACTION_CHANNEL_BLOCKED = 4;

    // Values for HealthConnectLatencyStats.session_data_type
    public static final int HEALTH_CONNECT_LATENCY_STATS__SESSION_DATA_TYPE__SESSION_DATA_TYPE_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_LATENCY_STATS__SESSION_DATA_TYPE__SESSION_DATA_TYPE_EXERCISE = 1;
    public static final int HEALTH_CONNECT_LATENCY_STATS__SESSION_DATA_TYPE__SESSION_DATA_TYPE_SLEEP = 2;

    // Values for HealthConnectRecordingMethodStats.data_type
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__DATA_TYPE_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__DATA_TYPE_NOT_ASSIGNED = 1;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__ACTIVE_CALORIES_BURNED = 2;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BASAL_BODY_TEMPERATURE = 3;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BASAL_METABOLIC_RATE = 4;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BLOOD_GLUCOSE = 5;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BLOOD_PRESSURE = 6;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BODY_FAT = 7;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BODY_TEMPERATURE = 8;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BONE_MASS = 9;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__CERVICAL_MUCUS = 10;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__CYCLING_PEDALING_CADENCE = 11;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__DISTANCE = 12;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__ELEVATION_GAINED = 13;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__EXERCISE_SESSION = 14;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__FLOORS_CLIMBED = 15;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__HEART_RATE = 16;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__HEIGHT = 17;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__HYDRATION = 18;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__LEAN_BODY_MASS = 19;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__MENSTRUATION_FLOW = 20;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__NUTRITION = 21;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__OVULATION_TEST = 22;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__OXYGEN_SATURATION = 23;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__POWER = 24;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__RESPIRATORY_RATE = 25;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__RESTING_HEART_RATE = 26;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__SEXUAL_ACTIVITY = 27;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__SPEED = 28;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__STEPS = 29;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__STEPS_CADENCE = 30;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__TOTAL_CALORIES_BURNED = 31;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__VO2_MAX = 32;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__WEIGHT = 33;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__WHEELCHAIR_PUSHES = 34;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__SKIN_TEMPERATURE = 35;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__PLANNED_EXERCISE_SESSION = 36;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__MINDFULNESS_SESSION = 37;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__BODY_WATER_MASS = 38;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__HEART_RATE_VARIABILITY_RMSSD = 39;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__INTERMENSTRUAL_BLEEDING = 40;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__MENSTRUATION_PERIOD = 41;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__SLEEP_SESSION = 42;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__ACTIVITY_INTENSITY = 43;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__NICOTINE_INTAKE = 44;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__SYMPTOMS = 46;

    // Values for HealthConnectRecordingMethodStats.recording_method
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__RECORDING_METHOD__RECORDING_METHOD_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__RECORDING_METHOD__RECORDING_METHOD_ACTIVE_RECORDED = 1;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__RECORDING_METHOD__RECORDING_METHOD_PASSIVE_RECORDED = 2;
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__RECORDING_METHOD__RECORDING_METHOD_MANUAL = 3;

    // Values for HealthConnectDeviceInfoStats.data_type
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__DATA_TYPE_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__DATA_TYPE_NOT_ASSIGNED = 1;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__ACTIVE_CALORIES_BURNED = 2;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BASAL_BODY_TEMPERATURE = 3;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BASAL_METABOLIC_RATE = 4;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BLOOD_GLUCOSE = 5;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BLOOD_PRESSURE = 6;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BODY_FAT = 7;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BODY_TEMPERATURE = 8;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BONE_MASS = 9;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__CERVICAL_MUCUS = 10;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__CYCLING_PEDALING_CADENCE = 11;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__DISTANCE = 12;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__ELEVATION_GAINED = 13;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__EXERCISE_SESSION = 14;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__FLOORS_CLIMBED = 15;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__HEART_RATE = 16;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__HEIGHT = 17;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__HYDRATION = 18;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__LEAN_BODY_MASS = 19;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__MENSTRUATION_FLOW = 20;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__NUTRITION = 21;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__OVULATION_TEST = 22;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__OXYGEN_SATURATION = 23;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__POWER = 24;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__RESPIRATORY_RATE = 25;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__RESTING_HEART_RATE = 26;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__SEXUAL_ACTIVITY = 27;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__SPEED = 28;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__STEPS = 29;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__STEPS_CADENCE = 30;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__TOTAL_CALORIES_BURNED = 31;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__VO2_MAX = 32;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__WEIGHT = 33;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__WHEELCHAIR_PUSHES = 34;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__SKIN_TEMPERATURE = 35;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__PLANNED_EXERCISE_SESSION = 36;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__MINDFULNESS_SESSION = 37;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__BODY_WATER_MASS = 38;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__HEART_RATE_VARIABILITY_RMSSD = 39;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__INTERMENSTRUAL_BLEEDING = 40;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__MENSTRUATION_PERIOD = 41;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__SLEEP_SESSION = 42;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__ACTIVITY_INTENSITY = 43;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__NICOTINE_INTAKE = 44;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__ALCOHOL_CONSUMPTION = 45;
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__SYMPTOMS = 46;

    // Values for HealthConnectDataGranularityStats.granularity_data_type
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_HEART_RATE = 1;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_SPEED = 2;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_POWER = 3;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_STEPS_CADENCE = 4;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_CYCLING_CADENCE = 5;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_SKIN_TEMPERATURE = 6;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_STEPS = 7;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_DISTANCE = 8;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_ACTIVE_CALORIES_BURNED = 9;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_TOTAL_CALORIES_BURNED = 10;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_ELEVATION_GAINED = 11;

    // Values for HealthConnectDataGranularityStats.data_state
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__DATA_STATE__DATA_STATE_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__DATA_STATE__DATA_STATE_ACTIVE = 1;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__DATA_STATE__DATA_STATE_PASSIVE = 2;

    // Values for HealthConnectNativeTrackingStatsReported.native_data_types_active
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_ACTIVE__NATIVE_TRACKING_DATA_TYPE_UNSPECIFIED = 0;
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_ACTIVE__NATIVE_TRACKING_DATA_TYPE_STEPS = 1;

    // Values for HealthConnectNativeTrackingStatsReported.native_data_types_disabled
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_DISABLED__NATIVE_TRACKING_DATA_TYPE_UNSPECIFIED = 0;
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_DISABLED__NATIVE_TRACKING_DATA_TYPE_STEPS = 1;

    // Values for HealthConnectNativeTrackingStatsReported.last_error_code
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__LAST_ERROR_CODE__NATIVE_TRACKING_ERROR_CODE_UNSPECIFIED = 0;
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__LAST_ERROR_CODE__NATIVE_TRACKING_ERROR_CODE_NONE = 1;
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
    public void write(int code, java.lang.String arg1, int arg2, boolean arg3, boolean arg4, boolean arg5) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        if (HEALTH_CONNECT_DEVICE_INFO_STATS == code) {
            builder.addIntAnnotation(StatsLog.ANNOTATION_ID_RESTRICTION_CATEGORY,
                                     StatsLog.RESTRICTION_CATEGORY_DIAGNOSTIC);
        }
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
    public void write(int code, java.lang.String arg1, int arg2, int arg3) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        if (HEALTH_CONNECT_RECORDING_METHOD_STATS == code) {
            builder.addIntAnnotation(StatsLog.ANNOTATION_ID_RESTRICTION_CATEGORY,
                                     StatsLog.RESTRICTION_CATEGORY_DIAGNOSTIC);
        }
        builder.writeString(arg1);
    ...
    public void write(int code, java.lang.String arg1, int arg2, long arg3) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeString(arg1);
        builder.writeInt(arg2);
    ...
    public void write(int code, java.lang.String arg1, int arg2, long arg3, int arg4) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeString(arg1);
        builder.writeInt(arg2);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public void write(int code, int[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
