...
public interface IPackageManagerNative extends android.os.IInterface
{
  ...
  public static class Default implements android.content.pm.IPackageManagerNative
  {
     ...
     */
    @Override public android.content.pm.PackageInfoNative getPackageInfoWithSigningInfo(java.lang.String packageName, int userId) throws android.os.RemoteException
    {
      return null;
    }
    /**
     ...
     */
    @Override public android.content.pm.PackageInfoNative[] getPackageInfoWithSigningInfoForUid(int uid) throws android.os.RemoteException
    {
      return null;
    }
    /**
     ...
     */
    @Override public int checkPermission(java.lang.String permName, java.lang.String packageName, int userId) throws android.os.RemoteException
    {
      return 0;
    }
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements android.content.pm.IPackageManagerNative
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getPackageInfoWithSigningInfo:
        {
          ...
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          android.content.pm.PackageInfoNative _result = this.getPackageInfoWithSigningInfo(_arg0, _arg1);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        case TRANSACTION_getPackageInfoWithSigningInfoForUid:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.content.pm.PackageInfoNative[] _result = this.getPackageInfoWithSigningInfoForUid(_arg0);
          reply.writeNoException();
    ...
    private static class Proxy implements android.content.pm.IPackageManagerNative
    {
      ...
      @Override public android.content.pm.PackageInfoNative getPackageInfoWithSigningInfo(java.lang.String packageName, int userId) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.content.pm.PackageInfoNative _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(packageName);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getPackageInfoWithSigningInfo, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.content.pm.PackageInfoNative.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public android.content.pm.PackageInfoNative[] getPackageInfoWithSigningInfoForUid(int uid) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(uid);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getPackageInfoWithSigningInfoForUid, _data, _reply, 0);
          _reply.readException();
          _result = _reply.createTypedArray(android.content.pm.PackageInfoNative.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
    ...
    static final int TRANSACTION_getPackageInfoWithSigningInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
    static final int TRANSACTION_getPackageInfoWithSigningInfoForUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
    static final int TRANSACTION_getPackageUid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
    static final int TRANSACTION_checkPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
    static final int TRANSACTION_getInstallerForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    static final int TRANSACTION_getVersionCodeForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_isAudioPlaybackCaptureAllowed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_getLocationFlags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
    static final int TRANSACTION_getTargetSdkVersionForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
    static final int TRANSACTION_getModuleMetadataPackageName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
    static final int TRANSACTION_hasSha256SigningCertificate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
    static final int TRANSACTION_isPackageDebuggable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
    static final int TRANSACTION_hasSystemFeature = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
    static final int TRANSACTION_registerStagedApexObserver = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
    static final int TRANSACTION_unregisterStagedApexObserver = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_getStagedApexInfos = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
  }
   ...
   * @return A PackageInfoNative object containing the package name and signing info.
   */
  public android.content.pm.PackageInfoNative getPackageInfoWithSigningInfo(java.lang.String packageName, int userId) throws android.os.RemoteException;
  /**
   * Retrieve signing information for application packages associated with the specified uid.
   * 
   * Note that the PackageInfoNative returned may contain unset @nullable fields.  This method
   ...
   * @return An array of PackageInfoNative objects containing package names and signing info.
   */
  public android.content.pm.PackageInfoNative[] getPackageInfoWithSigningInfoForUid(int uid) throws android.os.RemoteException;
  /**
   * Return the UID associated with the given package name.
   * Note that the same package will have different UIDs under different UserHandle on
   * the same device.
   ...
   *         specified permission, or PackageManager#PERMISSION_DENIED (-1) if it does not.
   */
  public int checkPermission(java.lang.String permName, java.lang.String packageName, int userId) throws android.os.RemoteException;
  /**
   * Returns the name of the installer (a package) which installed the named
   * package. Preloaded packages return the string "preload". Sideloaded packages
   * return an empty string. Unknown or unknowable are returned as empty strings.
