...
public final class PdfStatsLog {
     ...
     * Usage: StatsLog.write(StatsLog.RANKING_SELECTED, int event_id, java.lang.String package_name, int instance_id, int position_picked, boolean is_pinned, boolean included_extra_text_when_sharing_file);<br>
     */
     ...
     * Usage: StatsLog.write(StatsLog.PDF_API_USAGE_REPORTED, int uid, long doc_id, int api_type, int api_response_status, int operation_type);<br>
     */
    ...
    /**
     * FileAccessAttributesQueryReported file_access_attributes_query_reported<br>
     * Usage: StatsLog.write(StatsLog.FILE_ACCESS_ATTRIBUTES_QUERY_REPORTED, int sql_query_duration_millis, int leveldb_query_duration_millis, boolean is_data_consistent);<br>
     */
    public static final int FILE_ACCESS_ATTRIBUTES_QUERY_REPORTED = 1061;

    /**
     * OwnedPhotosRevokedFromAppReported owned_photos_revoked_from_app_reported<br>
     * Usage: StatsLog.write(StatsLog.OWNED_PHOTOS_REVOKED_FROM_APP_REPORTED, int revoked_ownership_item_count, int package_uid);<br>
     */
    public static final int OWNED_PHOTOS_REVOKED_FROM_APP_REPORTED = 1065;

    /**
     * MediaMetadataExtractionReported media_metadata_extraction_reported<br>
     * Usage: StatsLog.write(StatsLog.MEDIA_METADATA_EXTRACTION_REPORTED, int total_files_scanned, int files_scanned_from_backup, long avg_extraction_time_ns, int image_extracted_with_backup_count, long image_extracted_with_backup_avg_time_ns, int image_extracted_without_backup_count, long image_extracted_without_backup_avg_time_ns, int video_extracted_with_backup_count, long video_extracted_with_backup_avg_time_ns, int video_extracted_without_backup_count, long video_extracted_without_backup_avg_time_ns, int audio_extracted_with_backup_count, long audio_extracted_with_backup_avg_time_ns, int audio_extracted_without_backup_count, long audio_extracted_without_backup_avg_time_ns, int document_extracted_with_backup_count, long document_extracted_with_backup_avg_time_ns, int document_extracted_without_backup_count, long document_extracted_without_backup_avg_time_ns);<br>
     */
    public static final int MEDIA_METADATA_EXTRACTION_REPORTED = 1066;

    /**
     * MediaProviderOpReported media_provider_op_reported<br>
     * Usage: StatsLog.write(StatsLog.MEDIA_PROVIDER_OP_REPORTED, int op_type, int uri_type, int volume, int package_uid, long execution_time_nanos);<br>
     */
    public static final int MEDIA_PROVIDER_OP_REPORTED = 1112;

    /**
     * DeviceStorageStateReported device_storage_state_reported<br>
     * Usage: StatsLog.write(StatsLog.DEVICE_STORAGE_STATE_REPORTED, long device_storage_size_mb, int num_files_in_shared_storage, int num_images, int num_videos, int num_audio, int num_documents, int num_other_media, int num_in_default_documents, int num_in_default_downloads, int num_in_android_media, int files_shared_storage_size_mb, int images_storage_size_mb, int videos_storage_size_mb, int audio_storage_size_mb, int documents_storage_size_mb, int other_media_storage_size_mb, int default_downloads_storage_size_mb, int default_documents_storage_size_mb, int android_media_storage_size_mb);<br>
     */
    public static final int DEVICE_STORAGE_STATE_REPORTED = 1114;

    /**
     * DeviceStorageStatePerUidReported device_storage_state_per_uid_reported<br>
     * Usage: StatsLog.write(StatsLog.DEVICE_STORAGE_STATE_PER_UID_REPORTED, int package_uid, int num_owned_files, int owned_files_storage_size_mb, int num_images, int num_videos, int num_audio, int num_documents, int num_other_media);<br>
     */
    public static final int DEVICE_STORAGE_STATE_PER_UID_REPORTED = 1115;

    /**
     * PhotopickerSearchBarDisplayed photopicker_search_bar_displayed<br>
     * Usage: StatsLog.write(StatsLog.PHOTOPICKER_SEARCH_BAR_DISPLAYED, int session_id, int search_bar_state);<br>
     */
    public static final int PHOTOPICKER_SEARCH_BAR_DISPLAYED = 1130;
    ...
    public static final int PDF_API_USAGE_REPORTED__API_TYPE__API_TYPE_TEXT_PAGE_OBJECT = 2;
    public static final int PDF_API_USAGE_REPORTED__API_TYPE__API_TYPE_IMAGE_PAGE_OBJECT = 3;
    public static final int PDF_API_USAGE_REPORTED__API_TYPE__API_TYPE_PATH_PAGE_OBJECT = 4;
    public static final int PDF_API_USAGE_REPORTED__API_TYPE__API_TYPE_FREE_TEXT_ANNOTATION = 5;
    public static final int PDF_API_USAGE_REPORTED__API_TYPE__API_TYPE_HIGHLIGHT_ANNOTATION = 6;
    public static final int PDF_API_USAGE_REPORTED__API_TYPE__API_TYPE_STAMP_ANNOTATION = 7;
    ...
    // Values for PdfApiUsageReported.operation_type
    public static final int PDF_API_USAGE_REPORTED__OPERATION_TYPE__OPERATION_TYPE_UNKNOWN = 0;
    public static final int PDF_API_USAGE_REPORTED__OPERATION_TYPE__OPERATION_TYPE_ADD = 1;
    public static final int PDF_API_USAGE_REPORTED__OPERATION_TYPE__OPERATION_TYPE_REMOVE = 2;
    public static final int PDF_API_USAGE_REPORTED__OPERATION_TYPE__OPERATION_TYPE_UPDATE = 3;
    public static final int PDF_API_USAGE_REPORTED__OPERATION_TYPE__OPERATION_TYPE_LIST = 4;
    public static final int PDF_API_USAGE_REPORTED__OPERATION_TYPE__OPERATION_TYPE_GET_TOP_PAGE_OBJECT_AT_POS = 5;
    ...
    // Values for PhotopickerApiInfoReported.query_highlight_type
    public static final int PHOTOPICKER_API_INFO_REPORTED__QUERY_HIGHLIGHT_TYPE__HIGHLIGHT_QUERY_UNKNOWN = 0;
    public static final int PHOTOPICKER_API_INFO_REPORTED__QUERY_HIGHLIGHT_TYPE__HIGHLIGHT_QUERY_SEARCH = 1;
    public static final int PHOTOPICKER_API_INFO_REPORTED__QUERY_HIGHLIGHT_TYPE__HIGHLIGHT_QUERY_ALBUM = 2;
    ...
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__UI_LOADED_SEARCH_RESULT_TIMEOUT = 48;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__UI_LOADED_HSR_RESULTS = 49;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__UI_LOADED_HSR_TIMEOUT = 50;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_SELECT_HSR_RESULT = 51;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_SELECT_HSR_SEE_ALL = 52;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_SELECT_HSR_SUGGESTION_CHIP = 53;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_SEARCH_BAR_STATE = 54;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_SEARCH_SUGGESTION_TIMEOUT = 55;
    ...
    public static final int PHOTOPICKER_MEDIA_ITEM_STATUS_REPORTED__MEDIA_LOCATION__HIGHLIGHT_GRID = 6;
    ...
    // Values for MediaProviderOpReported.op_type
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__MEDIA_PROVIDER_OP_UNSPECIFIED = 0;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__ON_CREATE = 1;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__BULK_INSERT = 2;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__INSERT = 3;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__DELETE = 4;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__UPDATE = 5;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__OPEN_FILE = 6;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__OPEN_TYPED_ASSET_FILE = 7;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__OPEN_FILE_ASYNC = 8;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__OPEN_ASSET_FILE_ASYNC = 9;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__APPLY_BATCH = 10;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__ATTACH_VOLUME = 11;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__DETACH_VOLUME = 12;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__RESOLVE_PLAYLIST_MEMBERS_CALL = 20;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__GET_VERSION_CALL = 21;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__GET_GENERATION_CALL = 22;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__GET_DOCUMENT_URI_CALL = 23;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__GET_MEDIA_URI_CALL = 24;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__GET_REDACTED_MEDIA_URI_CALL = 25;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__GET_REDACTED_MEDIA_URI_LIST_CALL = 26;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__CREATE_WRITE_REQUEST_CALL = 27;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__CREATE_FAVORITE_REQUEST_CALL = 28;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__CREATE_TRASH_REQUEST_CALL = 29;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__CREATE_DELETE_REQUEST_CALL = 30;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__MARK_MEDIA_AS_FAVORITE = 31;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__PICKER_TRANSCODE_CALL = 32;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__SYNC_PROVIDERS_CALL = 33;
    public static final int MEDIA_PROVIDER_OP_REPORTED__OP_TYPE__BULK_UPDATE_OEM_METADATA_CALL = 34;

    // Values for MediaProviderOpReported.uri_type
    public static final int MEDIA_PROVIDER_OP_REPORTED__URI_TYPE__URI_UNSPECIFIED = 0;
    public static final int MEDIA_PROVIDER_OP_REPORTED__URI_TYPE__URI_MEDIA = 1;
    public static final int MEDIA_PROVIDER_OP_REPORTED__URI_TYPE__URI_MEDIA_PICKER = 2;
    public static final int MEDIA_PROVIDER_OP_REPORTED__URI_TYPE__URI_MEDIA_REDACTED = 3;
    public static final int MEDIA_PROVIDER_OP_REPORTED__URI_TYPE__URI_MEDIA_DOCUMENT = 4;

    // Values for MediaProviderOpReported.volume
    public static final int MEDIA_PROVIDER_OP_REPORTED__VOLUME__UNKNOWN = 0;
    public static final int MEDIA_PROVIDER_OP_REPORTED__VOLUME__INTERNAL = 1;
    public static final int MEDIA_PROVIDER_OP_REPORTED__VOLUME__EXTERNAL_PRIMARY = 2;
    public static final int MEDIA_PROVIDER_OP_REPORTED__VOLUME__EXTERNAL_OTHER = 3;

    // Values for PhotopickerSearchBarDisplayed.search_bar_state
    public static final int PHOTOPICKER_SEARCH_BAR_DISPLAYED__SEARCH_BAR_STATE__SEARCH_STATE_UNKNOWN = 0;
    public static final int PHOTOPICKER_SEARCH_BAR_DISPLAYED__SEARCH_BAR_STATE__SEARCH_STATE_ENABLED = 1;
    public static final int PHOTOPICKER_SEARCH_BAR_DISPLAYED__SEARCH_BAR_STATE__SEARCH_STATE_ENABLED_IN_OTHER_PROFILES = 2;
    public static final int PHOTOPICKER_SEARCH_BAR_DISPLAYED__SEARCH_BAR_STATE__SEARCH_STATE_DISABLED = 3;
    ...
    public static void write(int code, int arg1, int arg2) {
        ...
        if (OWNED_PHOTOS_REVOKED_FROM_APP_REPORTED == code) {
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, boolean arg8, boolean arg9, boolean arg10, boolean arg11, boolean arg12, boolean arg13, boolean arg14, int arg15) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (DEVICE_STORAGE_STATE_PER_UID_REPORTED == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeInt(arg2);
        builder.writeInt(arg3);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, long arg5) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
        builder.writeInt(arg3);
        builder.writeInt(arg4);
        if (MEDIA_PROVIDER_OP_REPORTED == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    public static void write(int code, int arg1, int arg2, long arg3, int arg4, long arg5, int arg6, long arg7, int arg8, long arg9, int arg10, long arg11, int arg12, long arg13, int arg14, long arg15, int arg16, long arg17, int arg18, long arg19) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, java.lang.String arg2, int arg3, int arg4, boolean arg5, boolean arg6) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
    ...
    public static void write(int code, long arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18, int arg19) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
