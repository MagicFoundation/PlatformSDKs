...
public final class TelephonyStatsLog {
    ...
    /**
     * SmsOtpRedacted sms_otp_redacted<br>
     * Usage: StatsLog.write(StatsLog.SMS_OTP_REDACTED, int redacted_uid, int redaction_algorithm, int redaction_location, int event_count_24_hours);<br>
     */
    public static final int SMS_OTP_REDACTED = 1136;

    /**
     * SmsOtpEvaluation sms_otp_evaluation<br>
     * Usage: StatsLog.write(StatsLog.SMS_OTP_EVALUATION, int redaction_time_ms, int result, int redaction_algorithm, int redaction_location);<br>
     */
    public static final int SMS_OTP_EVALUATION = 1137;
     ...
     * Usage: StatsLog.write(StatsLog.SIM_SLOT_STATE, int active_slot_count, int sim_count, int esim_count, int active_esim_slot_count, int active_mep_slot_count, int esim_slot_count);<br>
     */
    ...
    // Values for SmsOtpRedacted.redaction_algorithm
    public static final int SMS_OTP_REDACTED__REDACTION_ALGORITHM__REDACTION_ALGORITHM_UNSPECIFIED = 0;
    public static final int SMS_OTP_REDACTED__REDACTION_ALGORITHM__REDACTION_ALGORITHM_SMS_RETRIEVER = 1;
    public static final int SMS_OTP_REDACTED__REDACTION_ALGORITHM__REDACTION_ALGORITHM_ENGLISH_REGEX = 2;
    public static final int SMS_OTP_REDACTED__REDACTION_ALGORITHM__REDACTION_ALGORITHM_ML_MODEL = 3;
    public static final int SMS_OTP_REDACTED__REDACTION_ALGORITHM__REDACTION_ALGORITHM_OTHER = 4;

    // Values for SmsOtpRedacted.redaction_location
    public static final int SMS_OTP_REDACTED__REDACTION_LOCATION__REDACTION_LOCATION_UNSPECIFIED = 0;
    public static final int SMS_OTP_REDACTED__REDACTION_LOCATION__REDACTION_LOCATION_SMS_BROADCAST = 1;
    public static final int SMS_OTP_REDACTED__REDACTION_LOCATION__REDACTION_LOCATION_SMS_QUERY = 2;

    // Values for SmsOtpEvaluation.result
    public static final int SMS_OTP_EVALUATION__RESULT__EVALUATION_RESULT_NOT_CHECKED = 0;
    public static final int SMS_OTP_EVALUATION__RESULT__EVALUATION_RESULT_NO_OTP = 1;
    public static final int SMS_OTP_EVALUATION__RESULT__EVALUATION_RESULT_HAS_OTP = 2;

    // Values for SmsOtpEvaluation.redaction_algorithm
    public static final int SMS_OTP_EVALUATION__REDACTION_ALGORITHM__REDACTION_ALGORITHM_UNSPECIFIED = 0;
    public static final int SMS_OTP_EVALUATION__REDACTION_ALGORITHM__REDACTION_ALGORITHM_SMS_RETRIEVER = 1;
    public static final int SMS_OTP_EVALUATION__REDACTION_ALGORITHM__REDACTION_ALGORITHM_ENGLISH_REGEX = 2;
    public static final int SMS_OTP_EVALUATION__REDACTION_ALGORITHM__REDACTION_ALGORITHM_ML_MODEL = 3;
    public static final int SMS_OTP_EVALUATION__REDACTION_ALGORITHM__REDACTION_ALGORITHM_OTHER = 4;

    // Values for SmsOtpEvaluation.redaction_location
    public static final int SMS_OTP_EVALUATION__REDACTION_LOCATION__REDACTION_LOCATION_UNSPECIFIED = 0;
    public static final int SMS_OTP_EVALUATION__REDACTION_LOCATION__REDACTION_LOCATION_SMS_BROADCAST = 1;
    public static final int SMS_OTP_EVALUATION__REDACTION_LOCATION__REDACTION_LOCATION_SMS_QUERY = 2;
    ...
    public static final int OUTGOING_SMS__SEND_ERROR_CODE__SMS_SEND_ERROR_FAIL_AFTER_MAX_RETRY = 138;
    ...
    public static final int DATA_CALL_SESSION__DEACTIVATE_REASON__DEACTIVATE_REASON_DEVICE_SHUT_DOWN = 37;
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static StatsEvent buildStatsEvent(int code, int arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int[] arg17, int arg18, long arg19, boolean arg20, boolean arg21, int arg22, int[] arg23, int arg24, int arg25, int arg26, int arg27, int arg28, int arg29, int arg30, int arg31, java.lang.String[] arg32, int[] arg33, long[] arg34) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeBoolean(arg2);
        ...
        builder.writeStringArray(null == arg32 ? new String[0] : arg32);
        builder.writeIntArray(null == arg33 ? new int[0] : arg33);
        if (CARRIER_ROAMING_SATELLITE_SESSION == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeLongArray(null == arg34 ? new long[0] : arg34);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, boolean arg7, int arg8, boolean arg9, boolean arg10, int arg11, long arg12, int arg13, long arg14, int arg15, int arg16, int arg17, boolean arg18, boolean arg19, boolean arg20, boolean arg21, boolean arg22, int arg23, java.lang.String arg24, int arg25) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
        ...
        builder.writeString(arg24);
        builder.writeInt(arg25);
        if (OUTGOING_SMS == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7, int arg8, boolean arg9, int arg10, boolean arg11, boolean arg12, int arg13, long arg14, int arg15, boolean arg16, boolean arg17, boolean arg18, boolean arg19, int arg20) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18, int arg19, int arg20, int arg21, int arg22, int arg23, int arg24, int arg25, int arg26, int arg27, int arg28, boolean arg29, int arg30, int arg31, int arg32, int arg33, int arg34, int arg35, boolean arg36, int arg37, int arg38, int arg39, int arg40, int arg41, int arg42, int arg43, int arg44, int arg45) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
