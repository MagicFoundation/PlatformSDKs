...
public final class VirtualThread extends BaseVirtualThread {
    ...
    // Android-removed: Disable pinned threads tracing until it's supported.
    ...
    // Android-added: Moved interrupted status from Thread to VirtualThread.
    ...
    private void mount() {
        ...
        if (interrupted) {
            ...
            synchronized (interruptLock) {
                ...
                if (!interrupted) {
                    // Android-changed: Use a static method to clear interrupted status in carrier.
                    // carrier.clearInterrupt();
                    Thread.clearCarrierInterrupt();
                }
            }
        }
    ...
    void start(ThreadContainer container) {
        ...
        try {
            ...
            // Android-removed: Scoped value isn't supported on Android yet.
